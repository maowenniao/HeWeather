...
OPTIONS = dict(fl=["now.feelsLike", "实况体感温度", "mdi:temperature-celsius", "℃"],
               ...
               hum=["now.humidity", "实况室外湿度", "mdi:water-percent", "%Rh"],
               pcpn=["now.precip", "实况降水量", "mdi:weather-rainy", "mm"],
               pres=["now.pressure", "大气压强", "mdi:debug-step-over", "hPa"],
               vis=["now.vis", "实况能见度", "mdi:eye", "km"],
               wind_spd=["now.windSpeed", "实况风速", "mdi:speedometer", "km/h"],
               wind_sc=["now.windScale", "实况风力等级", "mdi:flag-variant", None],
               wind_dir=["now.windDir", "实况风向", "mdi:apple-safari", None],
               cond_txt=["now.text", "实况天气状况的文字描述，包括阴晴雨雪等天气状态的描述", "mdi:counter", None],
               qlty=["now.category", "实时空气质量指数级别", "mdi:beach", None],
               main=["now.primary", "实时空气质量的主要污染物", "mdi:chart-bar-stacked", None],
               aqi=["now.aqi", "实时空气质量指数", "mdi:poll", "AQI"],
               pm10=["now.pm10", "实时 pm10", "mdi:blur", "μg/m³"],
               pm25=["now.pm2p5", "实时 pm2.5", "mdi:blur", "μg/m³"],
               ...
               tmp_max=["daily.tempMax", "预报当天最高温度", "mdi:mdi:thermometer", "℃"],
               tmp_min=["daily.tempMin", "预报当天最低温度", "mdi:mdi:thermometer", "℃"],
               pop=["hourly.pop", "逐小时预报降水概率", "mdi:weather-rainy", "%"],
               cond_code=[])
